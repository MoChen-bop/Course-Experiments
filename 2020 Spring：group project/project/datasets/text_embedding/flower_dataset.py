...
__all__ = ['FlowerTextEmbeddingDataset', 'FlowerEextEmbeddingDatasetLazy']


class FlowerTextEmbeddingDataset(data.Dataset):
...
class FlowerTextEmbeddingDatasetLazy(data.Dataset):
...
if __name__ == '__main__':
    ...
    flower_img_text = FlowerTextEmbeddingDataset(dataset_dir='../../data/cvpr2016_flowers', avail_class_fn='allclasses.txt',
    	image_dir='images_h5', text_dir='text_c10', text_cutoff=80, device='cpu')
    # imgs, txts, lbls = flower_img_text.get_next_minibatch(n_txts=3)
    # print(imgs.shape) # 102 x 1024
    # print(txts.shape) # 102 x 3 x 69 x 80
    # print(lbls.shape) # 102
    for clas_txts, clas, i, lbl in flower_img_text.get_captions_and_info():
