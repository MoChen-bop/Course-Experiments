...
class CharDecoder(nn.Module):
    ...
    def forward(self, input, dec_hidden=None):
        ...
        char_embeddings = self.decoderCharEmb(input) # length x batch_size x char_embedding_size
        hidden_states, dec_hidden = self.charDecoder(char_embeddings, dec_hidden)
        scores = self.char_output_projection(hidden_states) # length x batch_size x vocab_size
