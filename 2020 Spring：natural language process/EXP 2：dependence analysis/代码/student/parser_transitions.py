...
class PartialParse(object):
    def __init__(self, sentence):
        ...
        self.stack = ['ROOT']
        self.buffer = [term for term in self.sentence]
        self.dependencies = []
    ...
    def parse_step(self, transition):
        ...
        if transition == 'S':
            ...
            self.dependencies.append((root, dependent))
            if self.buffer != [] or self.stack != []:
...
def minibatch_parse(sentences, model, batch_size):
    ...
    while unfinished_parses != []:
        ...
        unfinished_parses = [p for p in unfinished_parses if p.stack != []]
